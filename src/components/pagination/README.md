...
```javascript
import Vue from 'vue'
import OdsPagination from 'element-pagination'
import 'ods-theme-onesait/dist/pagination.css'

Vue.use(OdsPagination)
```
...
Vue.component('ods-pagination', OdsPagination)
```
