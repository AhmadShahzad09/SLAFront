...
```javascript
import Vue from 'vue'
import OdsTable from 'element-table'
import 'ods-theme-onesait'
...
import Vue from 'vue'
import { OdsTable } from 'element-table'
import { OdsTableColumn } from 'element-table'

Vue.component('ods-table', OdsTable)
Vue.component('ods-table-column', OdsTableColumn)
```
...
| resizable | 对应列是否可以通过拖动改变宽度（需要在 ods-table 上设置 border 属性为真） | boolean | — | true |
